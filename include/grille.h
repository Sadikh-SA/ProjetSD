 ...
 * \param h Entier représentant le nombre de hauteur que contient la grille.
 ...
 */
static inline void set_vivante(int i, int j, int k, grille g) { g.cellules[i][j] = 1; }
 ...
 * @param[out] g Grille
 */
static inline void set_non_viable(int i, int j, int k, grille g) { g.cellules[i][j] = -1; }
 ...
 */
static inline int est_vivante(int i, int j, int k, grille g) { return g.cellules[i][j] >= 1; }
 ...
 */
static inline int est_non_viable(int i, int j, int k, grille g) { return g.cellules[i][j] == -1; }
